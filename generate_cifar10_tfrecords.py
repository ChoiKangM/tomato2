...
# 이 부분 고치면 가능가능
CIFAR_FILENAME = 'ripenTomato.tar.gz'
#CIFAR_DOWNLOAD_URL = '/Users/kangminchoi/pythonproject/tomato/ripenTomato.zip' + CIFAR_FILENAME
CIFAR_LOCAL_FOLDER = 'ripenTomato'
